...
const Banner = () => {
  ...
  return (
    <div className=' flex bg-blue-600 rounded-3xl px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10 '>
        {/*----------banneer left-------------*/}
        <div className='flex-1 py-8 sm:py-10 md:py-16 lg:py-24 lg:pl-5'>
            <div className='text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold text-white'>
                <p>Book Appointment</p>
                <p className='mt-4 text-blue-900 text-5xl'>With 100+ Trusted Doctors</p>
            </div>
